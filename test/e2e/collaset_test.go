		...
		// trigger update
		{
			...
			Eventually(func() bool {
				...
				if rolloutRun.Status.BatchStatus != nil &&
					...
					rolloutRun.Status.BatchStatus.RolloutBatchStatus.CurrentBatchIndex == 0 &&
					rolloutRun.Status.BatchStatus.RolloutBatchStatus.CurrentBatchState == rolloutv1alpha1.RolloutStepPreBatchStepHook {
