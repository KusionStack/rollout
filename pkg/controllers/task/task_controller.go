...
//+kubebuilder:rbac:groups=rollout.kafe.kusionstack.io,resources=tasks,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=rollout.kafe.kusionstack.io,resources=tasks/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=rollout.kafe.kusionstack.io,resources=tasks/finalizers,verbs=update
