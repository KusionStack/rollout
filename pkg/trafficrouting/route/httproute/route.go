...
func (r *routeImpl) GetReadyCondition(routeObj client.Object) *metav1.Condition {
	cond := &metav1.Condition{
		Type:               "Ready",
		Status:             metav1.ConditionTrue,
		LastTransitionTime: routeObj.GetCreationTimestamp(),
		ObservedGeneration: routeObj.GetGeneration(),
	}
	if routeObj == nil {
