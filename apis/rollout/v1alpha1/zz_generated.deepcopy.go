...
func (in *CanaryStrategy) DeepCopyInto(out *CanaryStrategy) {
	*out = *in
	...
	if in.TemplateMetadataPatch != nil {
		in, out := &in.TemplateMetadataPatch, &out.TemplateMetadataPatch
...
func (in *HTTPRouteRule) DeepCopyInto(out *HTTPRouteRule) {
	*out = *in
	...
	if in.Filters != nil {
		...
		*out = make([]v1.HTTPRouteFilter, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *HTTPTrafficStrategy) DeepCopyInto(out *HTTPTrafficStrategy) {
	*out = *in
	...
	if in.BaseTraffic != nil {
		in, out := &in.BaseTraffic, &out.BaseTraffic
		*out = new(HTTPRouteRule)
		(*in).DeepCopyInto(*out)
	}
	return
